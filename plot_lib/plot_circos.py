...
@click.option('-c', '--chr_len', 'chr_len_file', help='Input chromosome length file. (Chr_num\\tLength\\n)')
@click.option('-d', '--gene_density', 'gene_density_file',
              help='Input gene density file. (Chr_num\\tStart\\tEnd\\tCount\\n)')
@click.option('-s', '--feature_stat', 'feature_stat', help='Input statistical file. (Chr_num\\tType\\tCount\\tColor\\n)')
@click.option('-l', '--link_file', 'link_file',
              help='Input associated site file. (Chr_num\\tStart\\tEnd\\tChr_num\\tStart\\tEnd\\tColor\\tDescription\\n)')
@click.option('-o', '--output_file', 'outfile', default='circos.pdf', help='[optional] Output file. {default=circos.pdf}')
