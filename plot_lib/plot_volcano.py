...
@click.option('-l', '--log2fc', 'log2fc', type=float, default=1.5,
              help='[optional] Set log2(fold change) as the threshold. {default: 1.5}')
@click.option('-p', '--p_adjust', 'p_adjust', type=float, default=0.05,
              help='[optional] Set padj as the threshold. {default: 0.05}')
@click.option('-s', '--figure_size', 'figure_size', default='6.0x8.0',
              help='[optional] Specify figure size. {default: 6.0x8.0}')
@click.option('-o', '--output_prefix', 'output_prefix', default='volcano',
              help='Prefix of output file. {default: volcano}')
@click.option('-O', '--output_format', 'output_format', default='pdf',
              ...
              help='Specify the format of output file. {default: pdf}')
