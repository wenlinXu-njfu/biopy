...
@click.option('-b', '--circ_bed', 'circ_bed_file',
              help='Input circRNA BED file. (Chr_num\\tStart\\tEnd\\tCirc_ID\\tFrame\\tStrand\\tEtc)')
@click.option('-f', '--circ_fasta', 'circ_fasta_file',
              help='[optional] CircRNA sequence FASTA file generated by CircToolKit subcommand "get_circ_seq" '
                   'to annotate the type of circRNA.')
@click.option('-n', '--alt_circ_num', 'alt_circ_num', type=int, default=2,
              help='[optional] Output sites which the number of alternative cyclization site exceeds specified value. '
                   '{default=2}')
