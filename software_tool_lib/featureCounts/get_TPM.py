...
@click.option('-m', '--min_exp', 'min_exp', type=float, default=0, show_default=True,
              help='[optional] Gene minimum expression threshold in all samples.')
@click.option('-o', '--output_prefix', 'output_prefix', default='TPM', show_default=True, help='Output file prefix.')
